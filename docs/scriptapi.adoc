...
argument specifies the number of digits after the decimal point plus the
leading digit.
* *Parameters:*
** `+precision+` (number): The number of digits after the decimal point plus the leading digit. 
