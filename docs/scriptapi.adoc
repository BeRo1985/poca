...
arrays as well as a rich set of methods on array ghost objects for
manipulating collections of values.
...
array operations. You can create array ghost objects using any of the
following variants:
...
literal syntax creates a new array ghost object by invoking the
underlying array creation routine. The resulting ghost object represents
a dynamic array, which is registered for subsequent array operations.
* *Parameters:*
...
elements.
* *Return Value:* A new array ghost object.
* *Example:*
+
[source,js]
----
...
=== Methods on Array Ghost Objects

Once created, array ghost objects provide the following methods:
...
* *Return Value:* The array ghost object itself.
* *Example:*
+
[source,js]
----
...
* *Return Value:* A new array ghost object containing the specified
elements.
* *Example:*
+
[source,js]
...
comparison.
* *Parameters:* None.
* *Return Value:* The sorted array ghost object itself.
* *Example:*
+
[source,js]
----
...
* *Return Value:* A new array ghost object with the specified range
filled.
* *Example:*
+
[source,js]
...
underlying array creation routine. The resulting ghost object represents
a dynamic array, which is registered for subsequent array operations.
* *Array Ghost Object Methods:* Once created, array ghost objects
provide the following methods to manipulate arrays:
