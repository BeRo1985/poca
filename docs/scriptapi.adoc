...
[source,js]
----
let factor = GarbageCollector.getFullIntervalFactor();
----
* *Description:* Returns the "`full interval factor`" that controls how
many cycles elapse before a full collection is triggered.
* *Return Value:* A numeric value (integer).
...
cycles elapse before an incremental collection is triggered.
* *Return Value:* A numeric value (integer).
...
[source,js]
----
let old = GarbageCollector.setFullIntervalFactor(100);
----
* *Description:* Sets the "`full interval factor`," which affects how
many cycles elapse before a full collection is triggered.
* *Parameters:*
** _newFullIntervalFactor_ (number): The new full interval factor.
* *Return Value:* The old full interval factor.
...
* *Description:* Sets the "`interval factor,`" which affects how many
cycles elapse before an incremental collection is triggered.
* *Parameters:*
