...
// Example code block
{ name; } // This is treated as a code block, not an object literal, because it is separated by a semicolon, for distinguishing it from an shorthand object literal
